...
const SignIn = () => {
    ...
    return (
        <main className="flex items-center flex-col justify-center h-[100% sm:p-0 p-[15px]" >
            <Logo />
            <section className="sm:w-[476px] w-[100%] mt-[30px] rounded-[12px] sm:p-[40px] p-[10px] sm:bg-white bg-transparent mx-auto h-fit">
                <header className="sm:mb-[40px] mb-[20px]">
                    ...
                    <p className="text-[16px] text-grey">Let&apos;s get you started sharing your links</p>
                </header>
